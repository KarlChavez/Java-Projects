...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        this.preStart = new Node(); //New Node
        this.postFinish = new Node(); //New Node
        this.postFinish.previous = this.preStart; //Point to start
        this.preStart.next = this.postFinish; //Point to finish
        this.lastLeft = this.preStart; //Point to start
        this.leftLength = 0;
        this.rightLength = 0;
    ...
    public final void addRightFront(T x) {
        ...
        newNode.data = x; //Data is the passing argument
        newNode.previous = this.lastLeft; //Point previous to last
        newNode.next = this.lastLeft.next; //Point next to last
        newNode.next.previous = newNode; //Insert node
        this.lastLeft.next = newNode; //Insert Node
        this.rightLength++;
    ...
    public final T removeRightFront() {
        ...
        Node remove = this.lastLeft.next; //Find the node
        this.lastLeft.next = remove.next; //Last next remove
        this.lastLeft.next.previous = this.lastLeft; //Close list
    ...
    public final void advance() {
        ...
        Node temp = this.lastLeft; //Find the node
        this.lastLeft = this.lastLeft.next; //Skip pointer
        this.lastLeft.previous = temp;
        this.leftLength++;
        this.rightLength--;
    ...
    public final void moveToStart() {
        ...
        this.lastLeft = this.preStart; //Change Pointers
    ...
    public final void moveToFinish() {
        ...
        this.lastLeft = this.postFinish.previous; //Left to before finish
        this.lastLeft.next = this.postFinish; //Last to finish
    ...
    public final void retreat() {
        ...
        this.lastLeft = this.lastLeft.previous; //Change to left side
        this.leftLength--;
        this.rightLength++;
