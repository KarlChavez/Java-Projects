...
public class Statement2 extends StatementSecondary {
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        StatementLabel sLabel = this.rep.disassemble(child);

        //cast incoming statement to Statement2
        Statement2 nChild = (Statement2) s;

        //using sequence "add" method. I could've also used secondary methods
        child.add(pos, nChild.rep);

        //Making new child a block
        this.rep.assemble(sLabel, child);
        nChild.createNewRep();
    ...
    public final Statement removeFromBlock(int pos) {
        ...
        //using sequence "remove" method. I could've also used secondary methods
    ...
    public final int lengthOfBlock() {
        ...
        //returns number of subtrees of the root
