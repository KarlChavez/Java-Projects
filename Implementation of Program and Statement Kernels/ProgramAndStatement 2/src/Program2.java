...
public class Program2 extends ProgramSecondary {
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // transfer context from this to temp, then transfer context from c into this
        //then finally transfer this' context into c from temp
    ...
    public final void swapBody(Statement b) {
        ...
        // transfer body from this to temp, then transfer body from b into this
        //then finally transfer this' body into b from temp
